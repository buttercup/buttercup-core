...
describe("ArchiveManager", function() {
        ...
        it("dehydrates after adding", function() {
            ...
            return this.archiveManager
                ...
                .then(id => {
                    ...
                    expect(this.archiveManager.sources.push.calledBefore(this.archiveManager.dehydrateSource)).to.be
                        .true;
                });
        });
    ...
    describe("dehydrateSource", function() {
        ...
        it("stores sources in a locked state", function() {
            ...
            return this.archiveManager.dehydrateSource(this.sourceID).then(() => {
    ...
    describe("lock", function() {
        ...
        it("locks an unlocked source", function() {
            return this.archiveManager.lock(this.sourceID).then(() => {
        ...
        it("encrypts credentials", function() {
            return this.archiveManager.lock(this.sourceID).then(() => {
                const source = this.archiveManager.sources[0];
                expect(source).to.have.property("sourceCredentials").that.is.a.string;
                expect(source).to.have.property("archiveCredentials").that.is.a.string;
            });
        });
    ...
    describe("rehydrate", function() {
        ...
        it("clears sources", function() {
            ...
            return this.archiveManager.rehydrate().then(() => {
                expect(this.archiveManager.sources).to.have.lengthOf(1);
            });
        });
    ...
    describe("remove", function() {
        beforeEach(function() {
            return Promise.all([
                createArchiveAndCredentials.call(this).then(() => {
                    return this.archiveManager
        ...
        it("removes sources", function() {
            expect(this.archiveManager.sources).to.have.lengthOf(2);
            return this.archiveManager.remove(this.sourceID1).then(() => {
                expect(this.archiveManager.sources).to.have.lengthOf(1);
        ...
        it("emits removal event", function() {
            sinon.spy(this.archiveManager, "emit");
            return this.archiveManager.remove(this.sourceID2).then(() => {
                expect(this.archiveManager.emit.firstCall.args).to.eql([
                    "sourceRemoved",
                    {
                        id: this.sourceID2
    ...
    describe("unlock", function() {
        ...
        it("sets the correct properties", function() {
            return this.archiveManager.unlock(this.sourceID, "testing").then(() => {
                expect(this.archiveManager.sources).to.have.lengthOf(1);
                const source = this.archiveManager.sources[0];
        ...
        it("restores the credentials", function() {
            return this.archiveManager.unlock(this.sourceID, "testing").then(() => {
                const source = this.archiveManager.sources[0];
                expect(source.sourceCredentials.getValue("datasource")).to.equal(
                    this.sourceCredentials.getValue("datasource")
                );
