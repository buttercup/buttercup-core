...
describe("marshalling", function() {
    ...
    describe("credentialsToDatasource", function() {
        ...
        it("creates a datasource", function() {
            ...
            return credentialsToDatasource(creds)
    ...
    describe("credentialsToSource", function() {
        ...
        it("attaches credentials", function() {
            return credentialsToSource(this.sourceCredentials, this.archiveCredentials)
                .then(result => {
                    expect(result).to.have.property("sourceCredentials")
                        .that.equals(this.sourceCredentials);
                    expect(result).to.have.property("archiveCredentials")
