...
describe("MemoryStorageInterface", function() {
    ...
    describe("getAllKeys", function() {
        ...
        it("returns all keys", function() {
            return this.storageInterface.getAllKeys()
                .then(keys => {
    ...
    describe("getValue", function() {
        ...
        beforeEach(function() {
            return Promise.all([
                this.storageInterface.setValue("key1", "value1")
            ]);
        });

        it("gets the correct value", function() {
            return this.storageInterface.getValue("key1")
                .then(value => {
        ...
        it("returns null if no key exists", function() {
            return this.storageInterface.getValue("key2")
                .then(value => {
    ...
    describe("removeKey", function() {
        ...
        it("removes the key", function() {
            return this.storageInterface.removeKey("key1")
